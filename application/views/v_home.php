...
<head>
    ...
    <link href='<?php echo base_url('assets/frontend/css/fontfamily.css') ?>' rel='stylesheet' type='text/css'>
...
<body>
 ...
 <div class="header">
          <a href="index.php" class="logo"><img src="assets/image/main-logo.svg"></a>
          <div class="header-menu">
              <div class="container">
                  <div class="burger"><em></em></div>
                  <!--<a href="#"><div id="show-login">Login</div></a>-->
                  <a class="cart" href="cart">Keranjang</a>                    <a href="konfirmasi-pembayaran" class="konpem">Konfirmasi Pembayaran</a>
                  <div class="src-but"></div>
              </div>
          </div>
      </div>
    ...
    <div id="all">
        ...
        <div id="content">
            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    <div id="main-slider" style="height:360px" >
                        <div class="item" style="height:360px" >
                            <img src="<?php echo base_url('assets/frontend/img/main-slider1.jpg') ?>" alt="" class="img-responsive">
                        </div>
                        <div class="item" style="height:360px" >
                            <img class="img-responsive" src="<?php echo base_url('assets/frontend/img/main-slider2.jpg') ?>" alt="">
                        </div>
                        <div class="item" style="height:360px" >
                            <img class="img-responsive" src="<?php echo base_url('assets/frontend/img/main-slider3.jpg') ?>" alt="">
                        </div>
                        <div class="item" style="height:360px" >
                            <img class="img-responsive" src="<?php echo base_url('assets/frontend/img/main-slider4.jpg') ?>" alt="">
                        </div>
                    </div>
                    <!-- /#main-slider -->
                </div>
